...
const copyReplacements = [
  ...
  [
    ...
    'Resvary 0.8 includes graduated and package pricing, recurring allowances, deterministic credit-lot allocation, Postgres persistence, durable self-hosted delivery, and the existing Testnet funding rails. Hosted billing, mainnet settlement, and managed operations remain planned work.',
  ],
  [
