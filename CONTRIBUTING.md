# Contributing to Resvary

Thank you for your interest in contributing to Resvary! This document provides guidelines and information about contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/resvary.git
   cd resvary
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/horn111/resvary.git
   ```
...
Feel free to open a [Discussion](https://github.com/horn111/resvary/discussions) or reach out in the [Circle Discord](https://circle.com/discord).
